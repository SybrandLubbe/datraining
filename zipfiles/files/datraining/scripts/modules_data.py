...
MODULES = [
    ...
    dict(num="00", slug="hero", title="Hero", category="layout", status="verified", minutes=6,
    ...
    dict(num="09", slug="highlight", title="Highlight", category="layout", status="verified", minutes=4,
    ...
    dict(num="11", slug="carousel", title="Carousel", category="layout", status="draft", minutes=2,
         ...
         images=[]),
    dict(num="12", slug="image", title="Image", category="layout", status="verified", minutes=5,
    ...
    dict(num="23", slug="header", title="Header (Nav)", category="site", status="verified", minutes=6,
